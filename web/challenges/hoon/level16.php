...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    if ($_POST['action'] === 'request_chocobi' && isset($_POST['amount'])) {
        ...
        // 웹 인터페이스를 통한 일반적인 요청일 경우에만 제한 적용
        if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] === 'XMLHttpRequest') {
            ...
            else if ($current_time - $_SESSION['last_request_time'] < 300) {
        ...
        if (!isset($_SESSION['error_message']) && $_SESSION['admin_chocobi'] >= $amount) {
            $_SESSION['user_chocobi'] += $amount;
            $_SESSION['admin_chocobi'] -= $amount;
            if ($amount >= 100) {
                $flag = "FLAG{JwvSpCXLLzLT6SWoWS7tKVD87m8D7M}";
                $_SESSION['success_message'] = "축하합니다! 짱구의 초코비를 훔쳤습니다! Flag: " . $flag;
            } else {
    ...
    <div class="miniroom-container">
        ...
        <div class="profile-section">
            ...
            <div class="profile-info">
                ...
                <p>⭐ 초코비 나눔 이벤트 진중! ⭐</p>
                <div class="today-box">
                    짱구의 보유 초코비: <?php echo $_SESSION['admin_chocobi']; ?>개<br>
        ...
        <div class="hint-box">
            <div class="hint-content">
                <h3>🎯 미션</h3>
                <p>짱구의 초코비 은행에 취약점이 발견되었습니다!</p>
                <p>초코비 전송 기능을 악용해보세요.</p>
